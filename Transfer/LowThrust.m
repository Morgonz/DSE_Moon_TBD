...
%[t3,y3] = ode45(@StartingOrbitAcc,[0 T/10],[y2(end,1) y2(end,2) y2(end,3) y2(end,4) y2(end,5) y2(end,6) y2(end,7) y2(end,8) y2(end,9) y2(end,10) y2(end,11) y2(end,12)],options1); %Starting orbit of the satellite
...
plot3(y(end,7),y(end,8),y(end,9),'ro') %mark last location of the Moon
